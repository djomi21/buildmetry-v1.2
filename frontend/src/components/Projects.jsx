    ...
    <div className="spl">
      ...
      {sp?(
        <div className="spl-r">
          ...
          {detailTab==='contracts'&&<div style={{flex:1,overflowY:"auto",padding:"16px 20px"}}><ContractsModule projectId={sp.id} apiBaseUrl="/api" company={company} scopeTemplates={scopeTemplates} exclusionTemplates={exclusionTemplates} svcs={svcs}/></div>}
        </div>
      ):(
